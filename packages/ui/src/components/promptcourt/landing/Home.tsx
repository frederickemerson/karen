...
export const Home: React.FC = () => (
  <section className="mx-auto grid min-h-[84dvh] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_420px] lg:px-8">
    <div>
      ...
      <p className="mt-6 max-w-2xl text-xl leading-8 text-[#4d4d4d]">
        If you cannot answer the questions, we git reset --hard.
      </p>
      <p className="mt-2 max-w-2xl text-xl leading-8 text-[#b7332c]">
        And we shame you on X.
      </p>
